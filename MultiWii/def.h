...
#if !defined(SERIAL_SUM_PPM) && !defined(SPEKTRUM) && !defined(SBUS) && !defined(SUMD) && !defined(HC12RX)
  #define STANDARD_RX
#endif
...
#ifdef HC12RX
  #if (!defined(PROMINI))
    #error "Currently HC12 is only supported for ATmega328P"
  #endif
  #if (!defined(QUADX) && !defined(QUADP) && !defined(Y4) && !defined(TRI))
    #error "Currently HC12 is only supported for QUADX, QUADP, Y4 or TRI configurations"
  #endif
#endif
